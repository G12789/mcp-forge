...
An [MCP](https://modelcontextprotocol.io) server (TypeScript, **streamable HTTP** transport), scaffolded with [mcp-quickstart](https://github.com/G12789/mcp-quickstart).
